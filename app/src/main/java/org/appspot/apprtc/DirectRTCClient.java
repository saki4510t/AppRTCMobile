...
/**
 * Implementation of org.appspot.apprtc.AppRTCClient that uses direct TCP connection as the signaling channel.
...
public class DirectRTCClient implements AppRTCClient, TCPChannelClient.TCPChannelEvents {
	...
	public void connectToRoom(RoomConnectionParameters connectionParameters) {
		...
		if (connectionParameters.loopback) {
			reportError("Loopback connections aren't supported by org.appspot.apprtc.DirectRTCClient.");
		}
	...
	private void connectToRoomInternal() {
		...
		if (!matcher.matches()) {
			reportError("roomId must match IP_PATTERN for org.appspot.apprtc.DirectRTCClient.");
			return;
		}
	...
	// -------------------------------------------------------------------
	// org.appspot.apprtc.TCPChannelClient event handlers
